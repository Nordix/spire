...
func (p *Plugin) setPodListCache(podList map[string]*Value, expires time.Duration) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *Plugin) getPodList(ctx context.Context, client *kubeletClient) (map[string]*Value, error) {
